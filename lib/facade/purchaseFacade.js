...
function placeOrder(orderDetails) {
    ...
    return purchaseOrderService.addPurchaserOrder(mappedOrder)
        .then(function (result) {
            ...
            return Promise.all([
                                    addOrderItems(items, orderID, orderDetails.purchaserID),
                                    updateStockInfo(items),
                                    updatePayments(orderDetails.payment, orderDetails.purchaserID)
                                ]);
        });
}
...
function mapOrderInfo(order) {
    ...
    mappedOrder.purchaserID = order.purchaserID;
