...
function getOrderItems(order) {
    ...
    for(let key in order){
        switch(key){
            case 'id': query._id = order.id; break;
            case 'brandName': query.brandName = order.brandName; break;
            case 'variantName': query.variantName = order.variantName; break;
            case 'fromDate': query.createdOn = {$gte : order.fromDate, $lte: order.endDate}; break;
            default: break;
        }
    }
